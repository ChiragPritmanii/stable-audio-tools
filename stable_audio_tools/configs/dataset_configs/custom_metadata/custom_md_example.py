def get_custom_metadata(fpath, info, audio):
    return {
        "prompt": {
            "path": f"{fpath}.wav",
            "seconds_start": info["seconds_start"].item(),
            "seconds_total": info["seconds_total"].item()
        }
    }
...
# from stable_audio_tools.configs.dataset_configs.custom_metadata.tokenizer.best_rq_vq.AudioTokenizer import (
#     AudioTokenizer,
# )
